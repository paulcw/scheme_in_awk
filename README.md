...
- I haven't yet written or applied a formal unit test system yet,
	...
	can bite you in the ass.  And it did; somehow I introduced a bug
	that broke some recursive functions. I probably need to add regression
	tests next, but this is hitting against the limit of Fun.
